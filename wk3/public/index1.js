...
// TODO: add code so that when the 'ht_search2' button is clicked, the
// artist is read in and an AJAX request is sent to your 'hometown' route
// on the server and then the map is set to the latitude and longitude 
